...
Original file is located at
    https://colab.research.google.com/drive/1WfADsgUOzKZMqTG6O2NKg7u1CqbEcSjN
"""
...
def binary_load_dataset(csv_loca, TEST_SIZE, VAL_SIZE, RANDOM_STATE):
  ...
  """
  # 글로벌로 만들어서 저장하기
  global df, X, y, X_train, X_val, X_test, y_train, y_val, y_test, X_train_ad, X_val_ad, X_test_ad, y_train_ad, y_val_ad, y_test_ad
